...
RSpec.describe AttributesController, type: :controller do
  ...
  describe "GET #edit" do
    it "assigns the requested attribute as @attribute" do
      attribute = Attribute.create! valid_attributes
      get :edit, params: {id: attribute.to_param}, session: valid_session
      expect(assigns(:attribute)).to eq(attribute)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created attribute" do
        post :create, params: {attribute: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Attribute.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the attribute" do
        attribute = Attribute.create! valid_attributes
        put :update, params: {id: attribute.to_param, attribute: valid_attributes}, session: valid_session
        expect(response).to redirect_to(attribute)
      end
    end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the attributes list" do
      attribute = Attribute.create! valid_attributes
      delete :destroy, params: {id: attribute.to_param}, session: valid_session
      expect(response).to redirect_to(attributes_url)
    end
  end
